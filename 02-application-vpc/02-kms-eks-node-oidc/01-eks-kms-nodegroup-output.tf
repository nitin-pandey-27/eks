...
output "kms_key_id" {
  description = "The name/id of the EKS KMS Key"
  value       = aws_kms_key.kms_eks_key.key_id
}

output "kms_key_arn" {
  description = "The arn of the EKS KMS Key"
  value       = aws_kms_key.kms_eks_key.arn
}
...
output "node_group_private_sg_id" {
  description = "Private Node Group SG ID"
  value       = aws_eks_node_group.eks_ng_private.resources
}

output "node_group_role_arn" {
  description = "Role ARN of Node Group"
